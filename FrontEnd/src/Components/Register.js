...
const Register = () => {
    ...
    //   }
    //   const saved = axios.post("http://127.0.0.1:8080/add",data);
    //   if(saved)
    //   {
    //     console.log(data);
    //   }
    ...
    //       confirmpassword: confirmpassword
    //     };
    //     const saved = await axios.post("http://127.0.0.1:8080/add", data);
    //     if (saved) {
    //       console.log(data);
    //     }
    //   } catch (error) {
    ...
    return (
        ...
        <p id='signup'>Already have an account? <Link to='/Login'>Sign in</Link></p>
        <div className='main'>
        <div id="fb">
            <a href='#'>
