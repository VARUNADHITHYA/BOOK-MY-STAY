...
const Footer = () =>{
    ...
    return(
        ...
        <div className="company">
            <p>BookMyStay</p>
            <Link to='/About' style={{textDecoration: 'none'}}><p className="clink">About Us</p></Link>
            <Link to='/Contact'style={{textDecoration: 'none'}}><p className="clink">Contact Us</p></Link>
            </div>
            <div className="vertical"></div>
        <div className="notify">
            <p id="class">Want to receive exclusive accommodation offers?<br></br>Subscribe to our <span style={{color:'rgb(11, 166, 201)'}}>newsletter.</span></p>
            <div>
            ...
            <div className="end">
            <p>Copyright<FontAwesomeIcon style={{padding:'0px 5px 0px 5px'}}/> &copy; 2023 BookMyStay. All rights reserved</p>
            </div>
            </div>
    );
}
